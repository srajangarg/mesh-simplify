...
#ifndef __DGP_SVD_hpp__
#define __DGP_SVD_hpp__
...
class DGP_API SVD
{
  public:
    ...
    static bool compute(InputMatrixT const & a, MatrixUT & u, std::vector<T> & d, MatrixVT & v);
...
DGP_API bool svdCore(AddressableMatrix<float>  & U, long rows, long cols, float  * D, AddressableMatrix<float>  & V);
DGP_API bool svdCore(AddressableMatrix<float>  & U, long rows, long cols, float  * D, AddressableMatrix<double> & V);
DGP_API bool svdCore(AddressableMatrix<float>  & U, long rows, long cols, double * D, AddressableMatrix<float>  & V);
DGP_API bool svdCore(AddressableMatrix<float>  & U, long rows, long cols, double * D, AddressableMatrix<double> & V);
DGP_API bool svdCore(AddressableMatrix<double> & U, long rows, long cols, float  * D, AddressableMatrix<float>  & V);
DGP_API bool svdCore(AddressableMatrix<double> & U, long rows, long cols, float  * D, AddressableMatrix<double> & V);
DGP_API bool svdCore(AddressableMatrix<double> & U, long rows, long cols, double * D, AddressableMatrix<float>  & V);
DGP_API bool svdCore(AddressableMatrix<double> & U, long rows, long cols, double * D, AddressableMatrix<double> & V);

template <typename MU>
typename std::enable_if< !std::is_base_of< ResizableMatrix<typename MU::Value>, MU >::value >::type
...
typename std::enable_if< !std::is_base_of< ResizableMatrix<typename MV::Value>, MV >::value >::type
...
template <typename M>
typename std::enable_if< !std::is_base_of< ResizableMatrix<typename M::Value>, M >::value >::type
...
class /* DGP_API */ SVDPseudoInverseImpl
{
  public:
    /**
     * Compute the Moore-Penrose pseudo-inverse of a (possibly rectangular) matrix A. If (A.transpose() * A) exists, the
...
template <typename InputMatrixT, typename OutputMatrixT>
class /* DGP_API */ SVDPseudoInverseImpl< InputMatrixT, OutputMatrixT,
                                          typename std::enable_if<
                                                       std::is_base_of< AddressableMatrix<typename OutputMatrixT::Value>,
                                                                        OutputMatrixT >::value >::type >
{
  public:
    static bool pseudoInverse(InputMatrixT const & a, OutputMatrixT & result, double tolerance = -1)
    {
...
template <typename InputMatrixT, typename MatrixUT, typename T, typename MatrixVT>
bool
SVD::compute(InputMatrixT const & a, MatrixUT & u, std::vector<T> & d, MatrixVT & v)
{
