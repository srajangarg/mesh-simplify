...
#ifndef __DGP_Math_hpp__
#define __DGP_Math_hpp__
...
extern DGP_API float const TRIG_TABLE[NUM_TRIG_STEPS + 1][3];

int const NUM_INV_TRIG_STEPS = 512;
extern DGP_API float const INV_TRIG_TABLE[NUM_INV_TRIG_STEPS + 1][3];
 ...
 */
DGP_API int binaryTreeDepth(long num_elems, int max_elems_in_leaf, Real split_ratio = 0.5);
 ...
 */
DGP_API int solveLinear(double c0, double c1, double * root);
 ...
 */
DGP_API int solveQuadratic(double c0, double c1, double c2, double * roots);
 ...
 */
DGP_API int solveCubic(double c0, double c1, double c2, double c3, double * roots);
 ...
 */
DGP_API int solveQuartic(double c0, double c1, double c2, double c3, double c4, double * roots);
