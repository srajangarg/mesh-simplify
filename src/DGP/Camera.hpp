...
#ifndef __DGP_Camera_hpp__
#define __DGP_Camera_hpp__
 ...
 * \endcode
 */
class DGP_API Camera : public Serializable
{
  public:
    /** Type of projection used by the camera (enum class). */
    struct DGP_API ProjectionType
    {
      /** Supported values. */
      enum Value
      {
    ...
    struct DGP_API ProjectedYDirection
    {
      ...
      DGP_ENUM_CLASS_BODY(ProjectedYDirection)
    };
