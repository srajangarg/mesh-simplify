...
#ifndef __DGP_Graphics_TextureFormat_hpp__
#define __DGP_Graphics_TextureFormat_hpp__
...
class DGP_API TextureFormat
{
  public:
    ...
    struct DGP_API Code
    {
      ...
      DGP_ENUM_CLASS_BODY(Code)
    };

    /** Color space of the format (enum class). */
    struct DGP_API ColorSpace
    {
      /** Supported values. */
      enum Value
      {
      ...
      DGP_ENUM_CLASS_BODY(ColorSpace)
    };

    /** Bayer pattern of the format (enum class). */
    struct DGP_API BayerPattern
    {
      /** Supported values. */
      enum Value
      {
      ...
      DGP_ENUM_CLASS_BODY(BayerPattern)
    };
  ...
  public:
    ...
    /** Returns the matching TextureFormat* identified by the Code.  May return NULL
      if this format's code is reserved but not yet implemented by DGP. */
