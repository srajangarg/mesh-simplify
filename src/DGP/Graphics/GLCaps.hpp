...
#ifndef __DGP_Graphics_GLCaps_hpp__
#define __DGP_Graphics_GLCaps_hpp__
...
#define DGP_SUPPORTS(extension)  (GLEW_##extension)
#define DGP_WGL_SUPPORTS(extension) (WGLEW_##extension)
#define DGP_GLX_SUPPORTS(extension) (GLXEW_##extension)
 ...
 */
class DGP_DLL_LOCAL GLCaps
{
  public:
    /** Common OpenGL vendors. */
    enum Vendor { ATI, NVIDIA, MESA, ARB };

    /** Maximum number of texture coordinates supported by RenderSystem; used to preallocate some static arrays. */
     ...
     * device is created. This is called for you if you use RenderSystem. It is safe to call this function twice as long
     ...
     *
     * If this bug is detected, Texture switches to RGBA8 formats for RGB8 data.
     */
     ...
     *
     * If this bug is detected, Texture reverts to software mipmap generation.
     */
