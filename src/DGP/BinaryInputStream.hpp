...
#ifndef __DGP_BinaryInputStream_hpp__
#define __DGP_BinaryInputStream_hpp__
 ...
 * operate on a whole std::vector or C-array. The first method resizes the std::vector to the appropriate size before reading. For a
 ...
 */
class DGP_API BinaryInputStream : public virtual NamedObject, private Noncopyable
{
  private:
...
#   define DGP_BINARY_INPUT_STREAM_DECLARE_READER(fname, tname) \
    void read##fname(int64 n, tname * out); \
    void read##fname(int64 n, std::vector<tname> & out);

    DGP_BINARY_INPUT_STREAM_DECLARE_READER(Bool8,               bool)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(UInt8,               uint8)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(Int8,                int8)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(UInt16,              uint16)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(Int16,               int16)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(UInt32,              uint32)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(Int32,               int32)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(UInt64,              uint64)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(Int64,               int64)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(Float32,             float32)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(Float64,             float64)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(Vector2,             Vector2)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(Vector3,             Vector3)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(Vector4,             Vector4)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(ColorL8,             ColorL8)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(ColorL,              ColorL)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(ColorRGB8,           ColorRGB8)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(ColorRGB,            ColorRGB)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(ColorRGBA8,          ColorRGBA8)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(ColorRGBA,           ColorRGBA)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(Matrix2,             Matrix2)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(Matrix3,             Matrix3)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(Matrix4,             Matrix4)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(CoordinateFrame3,    CoordinateFrame3)
    DGP_BINARY_INPUT_STREAM_DECLARE_READER(Plane3,              Plane3)
#   undef DGP_BINARY_INPUT_STREAM_DECLARE_READER
