...
#ifndef __DGP_TextInputStream_hpp__
#define __DGP_TextInputStream_hpp__
...
class DGP_API Token
{
  public:
    ...
    struct DGP_API ExtendedType
    {
      ...
      DGP_ENUM_CLASS_BODY(ExtendedType)
    };
...
class DGP_API ParseError : public std::runtime_error
{
  public:
    enum { UNKNOWN = -1 };
 ...
 * </pre>
 */
class DGP_API TextInputStream : public virtual NamedObject, private Noncopyable
{
  public:
    ...
    struct DGP_API Settings
    {
      ...
      /**
       * Parse -1.#IND00 as the floating point number returned by DGP::Math::nan(), -1.#INF00 as -DGP::Math::inf(), and 1.#INF00
       * as DGP::Math::inf(). Note that the C99 standard specifies that a variety of formats like "nan" are to be used; these
       * are supported by DGP::TextInputStream::Settings::simpleFloatSpecials.
       *
       ...
       */
      std::unordered_set<std::string>  trueSymbols;

      /** See trueSymbols. Default is {false}. */
      std::unordered_set<std::string>  falseSymbols;
  ...
  public:
    ...
    class DGP_API TokenException : public ParseError
    {
      public:
        /** Destructor. */
    ...
    class DGP_API BadMSVCSpecial : public TokenException
    {
      public:
        /** Constructor. */
        BadMSVCSpecial(
    ...
    class DGP_API WrongTokenType : public TokenException
    {
      public:
        Token::Type expected;
        Token::Type actual;
    ...
    class DGP_API WrongSymbol : public TokenException
    {
      public:
        std::string expected;
        std::string actual;
    ...
    class DGP_API WrongString : public TokenException
    {
      public:
        std::string expected;
        std::string actual;
