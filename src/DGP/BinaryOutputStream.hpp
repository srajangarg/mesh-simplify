...
#ifndef __DGP_BinaryOutputStream_hpp__
#define __DGP_BinaryOutputStream_hpp__
 ...
 * operate on a whole std::vector or C-array.
 *
 ...
 */
class DGP_API BinaryOutputStream : public virtual NamedObject, private Noncopyable
{
  private:
...
#define DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(fname, tname)\
    void write##fname(int64 n, tname const * out); \
    void write##fname(int64 n, std::vector<tname> const & out);

    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(Bool8,               bool)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(UInt8,               uint8)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(Int8,                int8)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(UInt16,              uint16)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(Int16,               int16)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(UInt32,              uint32)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(Int32,               int32)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(UInt64,              uint64)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(Int64,               int64)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(Float32,             float32)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(Float64,             float64)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(Vector2,             Vector2)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(Vector3,             Vector3)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(Vector4,             Vector4)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(ColorL8,             ColorL8)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(ColorL,              ColorL)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(ColorRGB8,           ColorRGB8)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(ColorRGB,            ColorRGB)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(ColorRGBA8,          ColorRGBA8)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(ColorRGBA,           ColorRGBA)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(Matrix2,             Matrix2)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(Matrix3,             Matrix3)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(Matrix4,             Matrix4)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(CoordinateFrame3,    CoordinateFrame3)
    DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER(Plane3,              Plane3)
#undef DGP_BINARY_OUTPUT_STREAM_DECLARE_WRITER
