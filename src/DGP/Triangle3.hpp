...
#ifndef __DGP_Triangle3_hpp__
#define __DGP_Triangle3_hpp__
 ...
 * @see Triangle3
 */
class DGP_API TriangleLocalVertexTriple3
{
  public:
    /** Default constructor. */
...
DGP_API int tri_tri_intersect(Real const V0[3],Real const V1[3],Real const V2[3],
                               Real const U0[3],Real const U1[3],Real const U2[3]);

DGP_API int NoDivTriTriIsect(Real const V0[3],Real const V1[3],Real const V2[3],
                              Real const U0[3],Real const U1[3],Real const U2[3]);

DGP_API int tri_tri_intersect_with_isectline(Real const V0[3],Real const V1[3],Real const V2[3],
                                              Real const U0[3],Real const U1[3],Real const U2[3],int *coplanar,
                                              Real isectpt1[3],Real isectpt2[3]);

// Check if a point is inside a triangle.
DGP_API bool isPointInsideTriangle(Vector3 const &  v0,
                                    Vector3 const &  v1,
                                    Vector3 const &  v2,
                                    int              primary_axis,
                                    Vector3 const &  p);
...
DGP_API Vector3 closestPointOnTrianglePerimeter(const Vector3   &   v0,
                                                 const Vector3   &   v1,
                                                 const Vector3   &   v2,
                                                 const Vector3   &   point);

// Intersection time of a ray with a triangle. Returns a negative value if the ray does not intersect the triangle.
DGP_API Real rayTriangleIntersectionTime(Ray3 const & ray, Vector3 const & v0, Vector3 const & edge01, Vector3 const & edge02);
...
class /* DGP_DLL_LOCAL */ Triangle3Base : public RayIntersectable3
{
  public:
 ...
 */
template <>
class DGP_API Triangle3<TriangleLocalVertexTriple3> : public Triangle3Base<TriangleLocalVertexTriple3>
{
  private:
...
class /* DGP_API */ Triangle3 : public Triangle3Base<VertexTripleT>
{
  private:
